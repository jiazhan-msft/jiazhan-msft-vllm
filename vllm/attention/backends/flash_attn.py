...
class FlashAttentionMetadata(AttentionMetadata):
    ...
    def prefill_metadata(self) -> Optional["FlashAttentionMetadata"]:
        ...
        self._cached_prefill_metadata = FlashAttentionMetadata(
            ...
            max_seq_tokens_tensor=self.max_seq_tokens_tensor[:self.num_prefills],
...
class FlashAttentionMetadataBuilder(
    ...
    def build(self, seq_lens: List[int], query_lens: List[int], max_seq_tokens_list: List[int],
        ...
        max_seq_tokens_tensor = torch.tensor(max_seq_tokens_list, dtype=torch.long, device=device)
